    ...
    <FadeInSection>
      <div>
        ...
        <p className="mb-4">
          ...
          understanding. It is designed for those who wish to grasp the
        ...
        <p className="mb-4">
          ...
          mastery that precedes all skill. Students rediscover the discipline
          that makes all craftsmanship possible: a mind ordered by purpose and a
          heart governed by peace.
        </p>
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-xs text-gray-600 mt-2 italic">
            Enrollment inquiries are received under Private Membership
            Agreement (PMA).
          </p>
        </div>
      </div>
